...
from funcs.agg import aggregate_up_down_ratio_weekly
...
if __name__ == '__main__':
    ...
    for r in range(len(df)):
        ...
        try:
            df_ticker = ticker.history(period='1wk')
    ...
    # 変動率の集計
    list_html, file_html = aggregate_up_down_ratio_weekly(df)
